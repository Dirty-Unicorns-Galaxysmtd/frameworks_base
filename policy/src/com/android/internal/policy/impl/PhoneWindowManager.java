...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.SHOW_NAVIGATION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
    ...
    public void updateSettings() {
        ...
        mHasNavigationBar = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.SHOW_NAVIGATION,
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        if (keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            if (Settings.System.getInt(mContext.getContentResolver(),
                ...
                if (down && repeatCount == 0) {
                    mHandler.postDelayed(mBackLongPress, Settings.System.getInt(mContext.getContentResolver(), Settings.System.KILL_APP_LONGPRESS_BACK_DELAY, 1000));
                }
            }
        } else if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (down) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_F5:
                ...
                if (down){
                    ...
                    mContext.sendBroadcastAsUser(new Intent("org.omnirom.torch.TOGGLE_FLASHLIGHT"),
